...
const About = () => {
  return (
    <>
      ...
      >
        I'm a skilled Web developer with experience in Three.js and TypeScript,
        Solidity, Rust, Python, Ruby on Rails, C++, C#, and expertise in
        frameworks like React-Three-Fiber, React, Node.js, and Next.js. I'm a
